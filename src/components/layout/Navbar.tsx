        ...
        <nav className="hidden md:flex items-center gap-8">
          ...
          <div className="flex items-center gap-3 border-l border-gray-200/80 pl-7">
            ...
            <a
              ...
              className="bg-[#25D366] hover:bg-[#1da851] text-white px-5 py-2.5 rounded-xl text-xs font-bold transition-colors shadow-sm hover:shadow-md uppercase tracking-wider flex items-center gap-2"
            >
              <svg
                width="16"
                height="16"
