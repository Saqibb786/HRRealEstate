...
export const Footer = () => {
  return (
    <footer className="bg-primary text-white pt-16 pb-24 md:pb-8 relative">
      ...
      {/* Mobile Sticky CTA */}
      <div className="fixed bottom-0 left-0 w-full md:hidden flex z-50 shadow-[0_-2px_15px_rgba(0,0,0,0.08)]">
        <a
          href="tel:03004237276"
          className="flex-1 bg-primary text-white text-center py-3.5 font-bold text-sm tracking-wide active:bg-primary-hover flex items-center justify-center gap-2"
        >
          <svg
            width="16"
            height="16"
        ...
        <a
          ...
          className="flex-1 bg-[#25D366] text-white text-center py-3.5 font-bold text-sm tracking-wide active:bg-[#128C7E] flex items-center justify-center gap-2"
          target="_blank"
          rel="noopener noreferrer"
        >
