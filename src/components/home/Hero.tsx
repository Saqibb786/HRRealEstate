      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10 flex flex-col items-center text-center max-w-5xl">
        ...
        <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
          <a
            ...
            className="inline-flex items-center justify-center gap-2 bg-primary text-white px-6 py-3.5 sm:px-8 sm:py-4 rounded-xl text-base sm:text-lg font-semibold shadow-glow hover:shadow-accent/40 hover:bg-primary-hover transition-all duration-200"
          >
            <svg
              width="18"
              height="18"
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-2 border-2 border-white text-white px-6 py-3.5 sm:px-8 sm:py-4 rounded-xl text-base sm:text-lg font-semibold hover:bg-white hover:text-primary transition-all duration-200"
          >
